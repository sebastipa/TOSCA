...
in which TOSCA is formulated. Sec. :ref:`overset-section` explains how to set up TOSCA cases with one-way nested domains (i.e. the 
...
solution is first performed using `tosca` executable, the simulation is then possibily restarted and `tosca2PV` is used in the end to 
