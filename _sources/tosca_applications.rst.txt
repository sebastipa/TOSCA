...
performed with spectral codes. 

On the other hand, spectral codes impose big limitation and are not flexible at all. The mesh has to be cartesian and uniform 
...
to conduct Machine Learning application within the code. 
