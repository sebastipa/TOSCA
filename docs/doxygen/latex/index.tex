...
Toolbox f\+Or Stratified Convective Atmospheres\hypertarget{index_autotoc_md0}{}\doxysection{\texorpdfstring{Recent Highlights/\+Additions}{Recent Highlights/\+Additions}}\label{index_autotoc_md0}
...
Now we can simulate real cases, wind rotating 360 degs, with terrain and turbines, all while damping gravity waves in all directions !!\hypertarget{index_autotoc_md1}{}\doxysection{\texorpdfstring{Executables}{Executables}}\label{index_autotoc_md1}
...
\end{DoxyVerb}
\hypertarget{index_autotoc_md2}{}\doxysection{\texorpdfstring{Boundary Conditions}{Boundary Conditions}}\label{index_autotoc_md2}
...
\end{DoxyVerb}
\hypertarget{index_autotoc_md3}{}\doxysection{\texorpdfstring{Wall Models}{Wall Models}}\label{index_autotoc_md3}
...
\end{DoxyVerb}
\hypertarget{index_autotoc_md4}{}\doxysection{\texorpdfstring{Turbulence Models}{Turbulence Models}}\label{index_autotoc_md4}
...
\end{DoxyVerb}
\hypertarget{index_autotoc_md5}{}\doxysection{\texorpdfstring{Turbine Models}{Turbine Models}}\label{index_autotoc_md5}
...
\end{DoxyVerb}
\hypertarget{index_autotoc_md6}{}\doxysection{\texorpdfstring{IBM Method}{IBM Method}}\label{index_autotoc_md6}
...
\end{DoxyVerb}
\hypertarget{index_autotoc_md7}{}\doxysection{\texorpdfstring{Acquisition System}{Acquisition System}}\label{index_autotoc_md7}
...
\end{DoxyVerb}
\hypertarget{index_autotoc_md8}{}\doxysection{\texorpdfstring{Future Implementations\+:}{Future Implementations\+:}}\label{index_autotoc_md8}
\begin{DoxyVerb}- Overset with fringe interpolation
- IBM smooth normals and thin-body augmented search
\end{DoxyVerb}
\hypertarget{index_autotoc_md9}{}\doxysection{\texorpdfstring{Notes\+:}{Notes\+:}}\label{index_autotoc_md9}
...
\item Save an environment variable that will tell TOSCA where PETSc is installed in your .bashrc\+: {\ttfamily echo "{}export PETSC\+\_\+\+DIR=\$\+HOME/your-\/-\/path-\/-\/to-\/-\/petsc"{} \texorpdfstring{$>$}{>}\texorpdfstring{$>$}{>} \$HOME/.bashrc}
\item Save an environment variable that will tell TOSCA which PETSc architecture is required in your .bashrc. Note\+: this is the folder within \$\+PETSC\+\_\+\+DIR with a name beginning with "{}arch-\/"{}. In a typical installation, it will be "{}arch-\/linux-\/c-\/opt"{}\+: {\ttfamily echo "{}export PETSC\+\_\+\+ARCH=arch-\/linux-\/c-\/opt"{} \texorpdfstring{$>$}{>}\texorpdfstring{$>$}{>} \$HOME/.bashrc}
\item Add the PETSc shared libraries to your library path environment variable in your .bashrc\+: {\ttfamily echo "{}export LD\+\_\+\+LIBRARY\+\_\+\+PATH=\$\+LD\+\_\+\+LIBRARY\+\_\+\+PATH\+:\$\+PETSC\+\_\+\+DIR/\$\+PETSC\+\_\+\+ARCH/lib"{} \texorpdfstring{$>$}{>}\texorpdfstring{$>$}{>} \$HOME/.bashrc}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md11}{}\doxysection{\texorpdfstring{Contribute to the TOSCA Project}{Contribute to the TOSCA Project}}\label{index_autotoc_md11}
...
\item Commit the changes using a short but exhaustive comment with {\ttfamily git commit -\/m "{}your-\/commit-\/description"{}}
\item Push your local branch online with {\ttfamily git push origin your-\/branch-\/name}
\item Go to github, select your branch, click on "{}\+Contribute"{} and open a pull-\/request describing the motivation of your changes, their effect on the code and the tests you performed.
...
\end{DoxyItemize}\hypertarget{index_autotoc_md12}{}\doxysection{\texorpdfstring{Paraview-\/\+Catalyst2 OS-\/\+Rendering}{Paraview-\/\+Catalyst2 OS-\/\+Rendering}}\label{index_autotoc_md12}
TOSCA provides full interface with Paraview-\/catalyst2 through the USE\+\_\+\+CATALYST flag in the makefile. If this is the case, the CATALYST environment variable should point to the catalyst2 installation directory. Paraview-\/catalyst is optional and can be disabled by setting USE\+\_\+\+CATALYST=0\hypertarget{index_autotoc_md13}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{index_autotoc_md13}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md14}{}\doxysection{\texorpdfstring{What does it do}{What does it do}}\label{index_autotoc_md14}
...
Prior to install TOSCA, we suggest to create a folder named {\ttfamily Software} inside {\ttfamily \$HOME}, where catalyst2 and paraview-\/5.\+11 will be located. In order to re-\/compile TOSCA with Paraview-\/catalyst2 capabilities on your system, please follow these steps\+:\hypertarget{index_autotoc_md16}{}\doxysection{\texorpdfstring{1. install Catalyst2}{1. install Catalyst2}}\label{index_autotoc_md16}
...
\item {\ttfamily echo "{}export CATALYST=\$\+LOCATION"{} \texorpdfstring{$>$}{>}\texorpdfstring{$>$}{>} \$HOME/.bashrc}
\item Add the Catalyst2 shared libraries to your library path environment variable in your .bashrc\+: {\ttfamily echo "{}export LD\+\_\+\+LIBRARY\+\_\+\+PATH=\$\+LD\+\_\+\+LIBRARY\+\_\+\+PATH\+:\$\+LOCATION/catalyst2/install/lib"{} \texorpdfstring{$>$}{>}\texorpdfstring{$>$}{>} \$HOME/.bashrc} Note\+: in some cases you may have to replace lib with lib64
\end{DoxyItemize}\hypertarget{index_autotoc_md17}{}\doxysection{\texorpdfstring{2. install Paraview-\/5.\+11}{2. install Paraview-\/5.\+11}}\label{index_autotoc_md17}
...
\item {\ttfamily cmake .. "{}\$\{\+FLAGS\mbox{[}@\mbox{]}\}"{}}
\item {\ttfamily make -\/j8}
\item {\ttfamily make install}
\item Add the Paraview shared libraries to your library path environment variable in your .bashrc\+: {\ttfamily echo "{}export LD\+\_\+\+LIBRARY\+\_\+\+PATH=\$\+LD\+\_\+\+LIBRARY\+\_\+\+PATH\+:\$\+LOCATION/paraview-\/5.\+11.\+0/install/lib"{} \texorpdfstring{$>$}{>}\texorpdfstring{$>$}{>} \$HOME/.bashrc} Note\+: in some cases you may have to replace lib with lib64
\end{DoxyItemize}\hypertarget{index_autotoc_md18}{}\doxysection{\texorpdfstring{3. Re-\/compile TOSCA}{3. Re-\/compile TOSCA}}\label{index_autotoc_md18}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md19}{}\doxysection{\texorpdfstring{4. Running}{4. Running}}\label{index_autotoc_md19}
